...
/**
 * Base class that represents a row from the 'fenric_section_field' table.
 *
 *
 *
 * @package    propel.generator.Propel.Models.Base
 */
abstract class SectionField implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Models\\Map\\SectionFieldTableMap';
    ...
    /**
     * Initializes internal state of Propel\Models\Base\SectionField object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>SectionField</code> instance.  If
     * <code>obj</code> is an instance of <code>SectionField</code>, delegates to
     * <code>equals(SectionField)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SectionField The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SectionFieldTableMap::COL_ID] = true;
        }
    ...
    public function setSectionId($v)
    {
        ...
        if ($this->section_id !== $v) {
            $this->section_id = $v;
            $this->modifiedColumns[SectionFieldTableMap::COL_SECTION_ID] = true;
        }
    ...
    public function setFieldId($v)
    {
        ...
        if ($this->field_id !== $v) {
            $this->field_id = $v;
            $this->modifiedColumns[SectionFieldTableMap::COL_FIELD_ID] = true;
        }
    ...
    public function setSequence($v)
    {
        ...
        if ($this->sequence !== $v) {
            $this->sequence = $v;
            $this->modifiedColumns[SectionFieldTableMap::COL_SEQUENCE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SectionFieldTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SectionFieldTableMap::translateFieldName('SectionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->section_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SectionFieldTableMap::translateFieldName('FieldId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSectionFieldQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SectionField::setDeleted()
     * @see SectionField::isDeleted()
     */
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SectionFieldTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(SectionFieldTableMap::COL_SECTION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'section_id';
        }
        if ($this->isColumnModified(SectionFieldTableMap::COL_FIELD_ID)) {
    ...
    {
        $pos = SectionFieldTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SectionField'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SectionField'][$this->hashCode()] = true;
        $keys = SectionFieldTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Models\SectionField
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Models\SectionField The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SectionFieldTableMap::COL_ID)) {
            $criteria->add(SectionFieldTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SectionFieldTableMap::COL_SECTION_ID)) {
            $criteria->add(SectionFieldTableMap::COL_SECTION_ID, $this->section_id);
        }
        if ($this->isColumnModified(SectionFieldTableMap::COL_FIELD_ID)) {
            $criteria->add(SectionFieldTableMap::COL_FIELD_ID, $this->field_id);
        }
        if ($this->isColumnModified(SectionFieldTableMap::COL_SEQUENCE)) {
    ...
    {
        $criteria = ChildSectionFieldQuery::create();
        $criteria->add(SectionFieldTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Models\SectionField (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Models\SectionField Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSection(ConnectionInterface $con = null)
    {
        if ($this->aSection === null && ($this->section_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSection->addSectionFields($this);
             */
        }
    ...
    {
        if ($this->aField === null && ($this->field_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aField->addSectionFields($this);
             */
        }
     ...
     * If this ChildSectionField is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSectionField The current object (for fluent API support)
     */
    public function setPublicationFields(Collection $publicationFields, ConnectionInterface $con = null)
    {
        ...
        foreach ($publicationFieldsToDelete as $publicationFieldRemoved) {
            $publicationFieldRemoved->setSectionField(null);
        }
    ...
    protected function doAddPublicationField(ChildPublicationField $publicationField)
    {
        ...
        $publicationField->setSectionField($this);
    }
    ...
    public function removePublicationField(ChildPublicationField $publicationField)
    {
        if ($this->getPublicationFields()->contains($publicationField)) {
            ...
            $publicationField->setSectionField(null);
        }
     ...
     * Otherwise if this SectionField is new, it will return
     * an empty collection; or if this SectionField has previously
     * been saved, it will retrieve related PublicationFields from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SectionField.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildPublicationField[] List of ChildPublicationField objects
     */
    public function getPublicationFieldsJoinPublication(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPublicationFieldQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aSection) {
            $this->aSection->removeSectionField($this);
        }
        if (null !== $this->aField) {
    ...
    {
        return (string) $this->exportTo(SectionFieldTableMap::DEFAULT_STRING_FORMAT);
    }
