...
/**
 * Base class that represents a row from the 'fenric_publication_relation' table.
 *
 *
 *
 * @package    propel.generator.Propel.Models.Base
 */
abstract class PublicationRelation implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Models\\Map\\PublicationRelationTableMap';
    ...
    /**
     * Initializes internal state of Propel\Models\Base\PublicationRelation object.
     */
    ...
    /**
     * Compares this with another <code>PublicationRelation</code> instance.  If
     * <code>obj</code> is an instance of <code>PublicationRelation</code>, delegates to
     * <code>equals(PublicationRelation)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PublicationRelation The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PublicationRelationTableMap::COL_ID] = true;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[PublicationRelationTableMap::COL_PUBLICATION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PublicationRelationTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = PublicationRelationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Models\\PublicationRelation'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPublicationRelationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PublicationRelation::setDeleted()
     * @see PublicationRelation::isDeleted()
     */
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PublicationRelationTableMap::COL_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO fenric_publication_relation (%s) VALUES (%s)',
    ...
    {
        $pos = PublicationRelationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PublicationRelation'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PublicationRelation'][$this->hashCode()] = true;
        $keys = PublicationRelationTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Models\PublicationRelation
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Models\PublicationRelation The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublicationRelationTableMap::COL_ID)) {
            $criteria->add(PublicationRelationTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PublicationRelationTableMap::COL_PUBLICATION_ID)) {
    ...
    {
        $criteria = ChildPublicationRelationQuery::create();
        $criteria->add(PublicationRelationTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Models\PublicationRelation (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Models\PublicationRelation Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPublication(ConnectionInterface $con = null)
    {
        if ($this->aPublication === null && ($this->publication_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPublication->addPublicationRelations($this);
             */
        }
    ...
    {
        if (null !== $this->aPublication) {
            $this->aPublication->removePublicationRelation($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(PublicationRelationTableMap::DEFAULT_STRING_FORMAT);
    }
