...
/**
 * Base class that represents a query for the 'fenric_publication_relation' table.
 *
 *
 *
 ...
 * @method     ChildPublicationRelationQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildPublicationRelationQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildPublicationRelationQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildPublicationRelationQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildPublicationRelationQuery leftJoinPublication($relationAlias = null) Adds a LEFT JOIN clause to the query using the Publication relation
 * @method     ChildPublicationRelationQuery rightJoinPublication($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Publication relation
 * @method     ChildPublicationRelationQuery innerJoinPublication($relationAlias = null) Adds a INNER JOIN clause to the query using the Publication relation
 *
 * @method     ChildPublicationRelationQuery joinWithPublication($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Publication relation
 *
 * @method     ChildPublicationRelationQuery leftJoinWithPublication() Adds a LEFT JOIN clause and with to the query using the Publication relation
 * @method     ChildPublicationRelationQuery rightJoinWithPublication() Adds a RIGHT JOIN clause and with to the query using the Publication relation
 * @method     ChildPublicationRelationQuery innerJoinWithPublication() Adds a INNER JOIN clause and with to the query using the Publication relation
 *
 * @method     \Propel\Models\PublicationQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildPublicationRelation findOne(ConnectionInterface $con = null) Return the first ChildPublicationRelation matching the query
 * @method     ChildPublicationRelation findOneOrCreate(ConnectionInterface $con = null) Return the first ChildPublicationRelation matching the query, or a new ChildPublicationRelation object populated from the query conditions when no match is found
 *
 ...
 *
 */
abstract class PublicationRelationQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Propel\Models\Base\PublicationRelationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\Models\\PublicationRelation', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildPublicationRelationQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildPublicationRelationQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildPublicationRelationQuery) {
            return $criteria;
        }
        $query = new ChildPublicationRelationQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildPublicationRelation|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(PublicationRelationTableMap::DATABASE_NAME);
        }
        ...
        if ((null !== ($obj = PublicationRelationTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
     ...
     *
     * @return ChildPublicationRelation A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildPublicationRelation $obj */
            $obj = new ChildPublicationRelation();
            $obj->hydrate($row);
            PublicationRelationTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PublicationRelationTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PublicationRelationTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PublicationRelationTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PublicationRelationTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublicationRelationTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByPublicationId($publicationId = null, $comparison = null)
    {
        if (is_array($publicationId)) {
            ...
            if (isset($publicationId['min'])) {
                $this->addUsingAlias(PublicationRelationTableMap::COL_PUBLICATION_ID, $publicationId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publicationId['max'])) {
                $this->addUsingAlias(PublicationRelationTableMap::COL_PUBLICATION_ID, $publicationId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublicationRelationTableMap::COL_PUBLICATION_ID, $publicationId, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildPublicationRelationQuery The current query, for fluid interface
     */
    public function filterByPublication($publication, $comparison = null)
    {
        if ($publication instanceof \Propel\Models\Publication) {
            return $this
                ->addUsingAlias(PublicationRelationTableMap::COL_PUBLICATION_ID, $publication->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PublicationRelationTableMap::COL_PUBLICATION_ID, $publication->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   ChildPublicationRelation $publicationRelation Object to remove from the list of results
     *
     * @return $this|ChildPublicationRelationQuery The current query, for fluid interface
     */
    public function prune($publicationRelation = null)
    {
        if ($publicationRelation) {
            $this->addUsingAlias(PublicationRelationTableMap::COL_ID, $publicationRelation->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Deletes all rows from the fenric_publication_relation table.
     *
    ...
    {
        if (null === $con) {
            $con = Propel::getServiceContainer()->getWriteConnection(PublicationRelationTableMap::DATABASE_NAME);
        }
        ...
        return $con->transaction(function () use ($con) {
            ...
            PublicationRelationTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(PublicationRelationTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            PublicationRelationTableMap::removeInstanceFromPool($criteria);
