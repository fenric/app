...
use Propel\Models\Base\PollVote as BasePollVote;

/**
 * Skeleton subclass for representing a row from the 'fenric_poll_vote' table.
 *
 ...
 */
class PollVote extends BasePollVote
{}
